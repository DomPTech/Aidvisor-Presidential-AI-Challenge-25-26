...
def get_recommendations(user_info, hf_api_key):
    ...
    Based on this information and your knowledge of disaster-prone areas or ongoing relief efforts (you can use your internal knowledge if no specific tool data is available, but act as a coordination expert), provide:
